...
import (
	...
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/mod/modexport"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/mod/modinit"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/mod/modupdate"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/push"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/branch/branchcreate"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/branch/branchlist"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/organization/organizationcreate"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/organization/organizationdelete"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/organization/organizationget"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/repository/repositorycreate"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/repository/repositorydelete"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/repository/repositoryget"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/repository/repositorylist"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/tag/tagcreate"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/beta/registry/tag/taglist"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/breaking"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/build"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/config/configlsbreakingrules"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/config/configlslintrules"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/convert"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/generate"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/lint"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/lsfiles"
	"github.com/powerman/buf/internal/buf/cmd/buf/command/protoc"
